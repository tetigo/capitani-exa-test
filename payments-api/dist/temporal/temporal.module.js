...
const temporalClient_service_1 = require("./temporalClient.service");
...
exports.TemporalModule = TemporalModule = __decorate([
    (0, common_1.Module)({
        providers: [temporalClient_service_1.TemporalClientService],
        exports: [temporalClient_service_1.TemporalClientService],
    })
], TemporalModule);
